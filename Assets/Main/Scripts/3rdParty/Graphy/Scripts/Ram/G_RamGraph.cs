...
namespace Tayx.Graphy.Ram
{
    public class G_RamGraph : G_Graph
    {
        ...
        [SerializeField] private    Image           m_imageLua = null;
        ...
        private                     G_GraphShader   m_shaderGraphLua = null;
        ...
        public void UpdateParameters()
        {
            ...
            switch (m_graphyManager.GraphyMode)
            {
                case GraphyManager.Mode.FULL:
                    ...
                    m_shaderGraphLua        .ArrayMaxSize = G_GraphShader.ArrayMaxSizeFull;
                ...
                case GraphyManager.Mode.LIGHT:
                    ...
                    m_shaderGraphLua        .ArrayMaxSize = G_GraphShader.ArrayMaxSizeLight;
        ...
        protected override void UpdateGraph()
        {
            ...
            float luaMemory         = m_ramMonitor.LuaRam;
            ...
            for (int i = 0; i <= m_resolution - 1; i++)
            {
                ...
                m_shaderGraphLua.Array[i]      = m_luaArray[i] / m_highestMemory;
            }
        ...
        protected override void CreatePoints()
        {
            ...
            m_shaderGraphLua.GoodThreshold         = 0;
            m_shaderGraphLua.CautionThreshold      = 0;
