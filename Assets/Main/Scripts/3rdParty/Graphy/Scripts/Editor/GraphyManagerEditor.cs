...
namespace Tayx.Graphy
{
    ...
    internal class GraphyManagerEditor : Editor
    {
        ...
        private SerializedProperty  m_luaRamColor;
        ...
        private void OnEnable()
        {
            ...
            m_luaRamColor                      = serObj.FindProperty("m_luaRamColor");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_ramModuleInspectorToggle)
            {
                ...
                m_luaRamColor.colorValue = EditorGUILayout.ColorField
                (
                    label: "- Lua",
                    value: m_luaRamColor.colorValue
                );
