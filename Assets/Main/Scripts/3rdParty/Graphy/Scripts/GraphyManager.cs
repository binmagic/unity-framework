...
namespace Tayx.Graphy
{
    ...
    public class GraphyManager : G_Singleton<GraphyManager>
    {
        ...
        [SerializeField] private    Color                   m_luaRamColor                      = new Color(1f, 0.51f, 0.33f);
        ...
        public Color LuaRamColor                        { get { return m_luaRamColor; } 
                                                          set { m_luaRamColor = value; m_ramManager.UpdateParameters(); } }
