...
namespace XLua
{
    public class SignatureLoader
    {
        ...
        LuaEnv.LuaFileInfo load_and_verify(ref string filepath)
        {
            var luaFileInfo = userLoader(ref filepath);
            var data = luaFileInfo.optionalBuf;
            if (data == null)
            {
                return luaFileInfo;
            }
...
#endif
            luaFileInfo.optionalBuf = filecontent;
            return luaFileInfo;
            //return filecontent;
        }
