...
public class UIScrollViewArrow : MonoBehaviour
{
    ...
    void Awake()
    {
        scroll = GetComponent<ScrollView>();
        if(scroll == null)
        {
            scroll = gameObject.GetComponentInParent<ScrollView>();
        }
        ResetSize();
    }
    ...
    private void ResetSize()
    {
        ...
        if (scroll == null || scroll.content == null)
            return;
        if (scroll.LayoutType == ScrollView.ScrollViewLayoutType.Horizontal)
        {
        ...
        else if (scroll.LayoutType == ScrollView.ScrollViewLayoutType.Vertical)
        {
